...
const testimonials = [
  {
    ...
    rating: 5,
    review: "I was terrified to start working out as a complete beginner. FitStart made it so easy! Lost 15 lbs in my first 8 weeks and actually enjoy exercising now.",
  ...
  },
  {
    ...
    rating: 5,
    review: "The video guidance is incredible. Every exercise is explained perfectly. I've tried other programs but nothing compares to FitStart's beginner-focused approach.",
  ...
  },
  {
    ...
    rating: 5,
    review: "Finally a fitness program that doesn't assume you know everything! The nutrition guide alone was worth it. Down 20 lbs and feeling stronger than ever.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-xl mx-auto">
            Real results from real beginners who transformed their lives with FitStart.
          </p>
        </div>
