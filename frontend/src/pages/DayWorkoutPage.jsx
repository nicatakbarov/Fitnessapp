      ...
      <main className="pt-24 pb-32 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h1 className="font-heading text-3xl md:text-4xl font-bold text-white uppercase" data-testid="day-title">
            ...
            <div className="space-y-4">
              {dayData.mainWorkout.map((exercise, index) => {
                ...
                return (
                  ...
                  >
                    <div className="p-5 cursor-pointer select-none" onClick={() => toggleExercise(key)}>
